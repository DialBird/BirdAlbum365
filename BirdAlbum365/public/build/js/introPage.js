...
/***/ function(module, exports, __webpack_require__) {
	...
	//プロセスモジュール
	var preloadData = __webpack_require__(1);
	...
	//プロセス
	preloadData(NameSpace).then(init).then(main);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (NameSpace) {
	    return new Promise(function (resolve) {
	        var manifest = [{ id: 'birdSpriteImg', src: './build/img/birdSprite.min.jpg' }, { id: 'birdSpriteJSON', src: 'json/birdSprite.json' }, { id: 'birdNamesJSON', src: 'json/birdNames.json' }];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlaneCircleGenerator = __webpack_require__(12);
	...
	module.exports = function (NameSpace) {
	    ...
	    function startEmergePlanes() {
	        //クラスの呼び出し
	        var PCG = new PlaneCircleGenerator(NameSpace);
	        var toggle = false;
	    ...
	    $(window).on('resize', function () {
	        ...
	        var renderer = NameSpace.Canvas.renderer;
	        renderer.setSize(width, width * 8 / 13);
	    });

	    //スクロールでthreeJSのカメラが動くようにする
	    function rotateCamera(_scrollTop) {
	        if (NameSpace.Canvas.camera === null) {
	            return;
	        }
	        var camera = NameSpace.Canvas.camera;
	        //1200という値は適当。見栄え的に決定
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlaneCircleGenerator = function () {
	    function PlaneCircleGenerator(NameSpace) {
	        _classCallCheck(this, PlaneCircleGenerator);
	    ...
	    _createClass(PlaneCircleGenerator, [{
	        key: 'generate',
	        value: function generate(_bool, _startX) {
	            //まずplaneの円をを作成する
	        ...
	        key: 'createPlaneCircle',
	        value: function createPlaneCircle() {
	        ...
	        key: 'startAnimation',
	        value: function startAnimation(_planeCircle, _bool, _startX) {
